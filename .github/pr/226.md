...
- `print_results(all_results, icons)` - formatted result display
- `print_summary(checker_name, results)` - summary line
- `print_failures(all_results)` - detailed failure output
...
- [x] all tests pass (31 passed, 0 failed, 1 skipped)
