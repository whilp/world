...
- **Last updated**: 2026-01-03 22:13:30 UTC
- **Branch**: claude/integrate-pr-lua-cosmic-Ac5dc
- **Invocation**: `cosmic-lua -l skill update-pr`
- **Module location**: lib/skill/
- **Test coverage**: Unit tests (parsing, GitHub API) + integration tests (cosmic bundling, invocation)
