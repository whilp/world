# pr: extract pr.lua fixes and add environment tests

Extract pr.lua-related fixes from cosmic-lua-build branch and add comprehensive test coverage for different execution environments.
