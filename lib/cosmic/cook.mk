...
$(cosmic_bin): $(cosmic_libs) $(cosmic_lfs) $(skill_libs) $(skill_hook_libs) $(cosmic_main) $(cosmic_args)
	@rm -rf $(cosmic_built)
	@mkdir -p $(cosmic_built)/.lua/cosmic $(cosmic_built)/.lua/skill $(cosmic_built)/.lua/skill/hook $(@D)
	@$(cp) $(cosmic_libs) $(cosmic_built)/.lua/cosmic/
	@$(cp) $(cosmic_lfs) $(cosmic_built)/.lua/
	@$(cp) $(skill_libs) $(cosmic_built)/.lua/skill/
	@$(cp) $(skill_hook_libs) $(cosmic_built)/.lua/skill/hook/
