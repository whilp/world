...
function TestTimestampPreservation:setUp()
...
function TestTimestampPreservation:test_uses_archive_mtime()
  ...
  local extracted_file1 = path.join(self.dest, "file1.txt")
  local extracted_file2 = path.join(self.dest, "file2.txt")

  lu.assertTrue(file_exists(extracted_file1))
  lu.assertTrue(file_exists(extracted_file2))
