...
# Updated	: $Date: 2006/04/23 14:56:02 $
# Vim		: :vim: set ft=sh:
# CVS		: $Id: profile,v 1.128 2006/04/23 14:56:02 will Exp $
...
RCP_CMD="$(which scp)"
VERBOSE="1"
export CLUSTER CVSEDITOR CVS_RSH EDITOR LANG MAIL PATH RCMD_CMD RCP_CMD SHELL VERBOSE
