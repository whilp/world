...
container_pull(
    name = "renovate",
    digest = "sha256:0fdba52514acb1d5af01dcf70e5c49d70981bf7daa848730e5b9f3eefb01c858",
    registry = "docker.io",
...
http_archive(
    ...
    strip_prefix = "golangci-lint-1.37.1-linux-amd64",
    urls = ["https://github.com/golangci/golangci-lint/releases/download/v1.37.1/golangci-lint-1.37.1-linux-amd64.tar.gz"],
)
...
http_archive(
    ...
    sha256 = "4e2eece7efb110359205b8a0ce5f7ca672cbba8a6a717510866925c2238d8f49",
    urls = ["https://github.com/denoland/deno/releases/download/v1.7.5/deno-x86_64-unknown-linux-gnu.zip"],
)
