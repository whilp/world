...
container_pull(
    name = "cc_image_base",
    digest = "sha256:32b90ed68c5ed05a1786f918411e4d02151f43ec85d54ba0624c6a5a3c02c62b",
    registry = "gcr.io",
...
http_archive(
    ...
    sha256 = "df8cc225db877964b1931973af9607fdf3c63aeddb8ae945c919f5b01a09d53e",
    urls = ["https://github.com/denoland/deno/releases/download/v1.7.2/deno-x86_64-unknown-linux-gnu.zip"],
)
...
http_file(
    ...
    urls = ["https://github.com/bazelbuild/bazel-watcher/releases/download/v0.15.0/ibazel_linux_amd64"],
)
