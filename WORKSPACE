...
container_pull(
    ...
    digest = "sha256:a578422f6336b1ac7d81d8eb47cae19f2ec6a12f93087aaeca07a40a3045507c",
    registry = "gcr.io",
...
container_pull(
    name = "renovate",
    digest = "sha256:afb4b49384c1ae0a4ffba3541af8d58756f7eb241059dd6224e0f2fdd2d088bf",
    registry = "docker.io",
...
http_archive(
    ...
    strip_prefix = "golangci-lint-1.35.2-linux-amd64",
    urls = ["https://github.com/golangci/golangci-lint/releases/download/v1.35.2/golangci-lint-1.35.2-linux-amd64.tar.gz"],
)
...
http_archive(
    ...
    sha256 = "7a5f8fbe2131e6ddcc294ed1abbb19c9fe7ab9449762573236f3d900885635cf",
    urls = ["https://github.com/denoland/deno/releases/download/v1.7.0/deno-x86_64-unknown-linux-gnu.zip"],
)
