return {
  ...
  binaries = {
    ...
    delta = {
      executable_path = "delta-0.18.2-aarch64-apple-darwin/delta",
    ...
    gh = {
      executable_path = "gh_2.79.0_macOS_arm64/bin/gh",
    ...
    luajit = {
      executable_path = "luajit-2025.10.16-25a61a18-darwin-arm64/bin/luajit",
    ...
    nvim = {
      executable_path = "nvim-macos-arm64/bin/nvim",
    ...
    rg = {
      executable_path = "ripgrep-14.1.1-aarch64-apple-darwin/rg",
      sha256 = "0e0cb83f5195f1f51bb8feef1fff5b0b171e82bd1db6bd35deee701a3e7102f8",
      url = "https://github.com/BurntSushi/ripgrep/releases/download/14.1.1/ripgrep-14.1.1-aarch64-apple-darwin.tar.gz",
    },
    ruff = {
      executable_path = "ruff-aarch64-apple-darwin/ruff",
    ...
    superhtml = {
      executable_path = "aarch64-macos/superhtml",
    ...
    uv = {
      executable_path = "uv-aarch64-apple-darwin/uv",
