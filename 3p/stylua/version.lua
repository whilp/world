return {
  ...
  platforms = {
    ["darwin-arm64"] = {
      url = "https://github.com/JohnnyMorganz/StyLua/releases/download/v${version}/stylua-macos-aarch64.zip",
      sha = "3d9caaa660da4b3bc092e805d09af59e42b7504f1253c863b682ea3fc80944f2",
    },
    ["linux-arm64"] = {
      url = "https://github.com/JohnnyMorganz/StyLua/releases/download/v${version}/stylua-linux-aarch64.zip",
