...
def repo():
    ...
    http_archive(
        ...
        url = "https://github.com/bazelbuild/rules_go/archive/40e2b78a314ebb91d0e690579ed3273683a3a1a1.tar.gz",
    )
    ...
    http_archive(
        ...
        url = "https://github.com/bazelbuild/bazel-gazelle/archive/bc107b5e24000561e825056ca193b6745e5d2867.tar.gz",
    )
    ...
    http_archive(
        ...
        url = "https://github.com/bazelbuild/rules_docker/archive/4282829a554058401f7ff63004c8870c8d35e29c.tar.gz",
    )
    ...
    http_archive(
        ...
        url = "https://github.com/google/subpar/archive/07ff5feb7c7b113eea593eb6ec50b51099cf0261.tar.gz",
    )
