...
cosmos_version := 2025.12.31-fd52faee8
cosmos_url := https://github.com/whilp/cosmopolitan/releases/download/$(cosmos_version)

$(eval $(call download_binary_rule,cosmos,lua,$(cosmos_url)/lua,cf0644beee891c3bdae4dfdba43ff1918e14f1b3a9c15071db800e42ac9ee4a1))
