...
cosmos_version := 2025.12.28-57af99c51
cosmos_url := https://github.com/whilp/cosmopolitan/releases/download/$(cosmos_version)

$(eval $(call download_binary_rule,cosmos,lua,$(cosmos_url)/lua,2607d8aaeb42712f340e0fec78c258e0b894d9bf7d032eaf980a9be6dda465b3))
